...
| :--- | :--- | :--- |
| 🌿 **Leaf Disease Detection** | ML model trained on 40K+ images for plant disease classification. | Python, CNN |
| 🎓 **AlumniConnect** | Full-stack alumni platform for networking & management. | React, Node.js |
| 📱 **Social Media App** | Backend system with authentication, posts & APIs. | FastAPI, MongoDB |
